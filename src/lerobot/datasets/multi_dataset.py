...
class MultiLeRobotDataset(torch.utils.data.Dataset):
    ...
    def __init__(
        ...
        # Existing training code expects LeRobotDataset's ``meta`` interface.
        # The four CR3 mixture datasets share features/fps, so copy the first
        # metadata object and replace its normalization statistics with the
        # aggregate statistics used by all sources.
        self.meta = copy.copy(self._datasets[0].meta)
