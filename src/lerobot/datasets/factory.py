...
def make_dataset(cfg: TrainPipelineConfig) -> LeRobotDataset | MultiLeRobotDataset:
    ...
    if cfg.mixture is not None:
        ...
        ds_meta = LeRobotDatasetMetadata(
            mixture.repo_ids[0], root=Path(mixture.root) / mixture.repo_ids[0]
        )
        ...
        logging.info(
            "Created fixed-ratio mixture dataset with source mapping: %s",
            pformat(dataset.repo_id_to_index, indent=2),
        )
